...
export default function NewGame() {
  ...
  async function handleSubmit(e) {
    ...
    const gameData = {
      ...
      pitcher_name: form.pitcher_name,
      pitcher_throws: form.pitcher_throws,
      pitcher_number: form.pitcher_number,
      notes: form.notes,
      pitches: [],
      custom_pitches: [],
    ...
    try {
      const { data } = await saveGame(gameData)
      if (!data || !data.id) {
      ...
      alert('Game creation failed: ' + err.message)
      setSaving(false)
    }
  }
